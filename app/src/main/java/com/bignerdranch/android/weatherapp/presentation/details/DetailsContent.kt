...
import com.bignerdranch.android.weatherapp.presentation.extensions.formattedFullDay
import com.bignerdranch.android.weatherapp.presentation.extensions.formattedShortDayOfWeek
    ...
    Scaffold(
        ...
        topBar = {
            TopBar(
                ...
                onChangeFavouriteStateClick = { component.onClickChangeFavouriteStatus() }
            )
        },
        modifier = Modifier
            .fillMaxSize()
...
private fun TopBar(
    ...
    CenterAlignedTopAppBar(
        ...
        actions = {
            IconButton(onClick = { onChangeFavouriteStateClick() }) {
